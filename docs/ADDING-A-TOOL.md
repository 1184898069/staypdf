...
1. Catalog. Add a ToolDef in api/StayPdf.Api/Jobs/ToolCatalog.cs (Id, RequiresPro). Free: merge, split, rotate, delete, images. Pro: compress, ocr, word, watermark, pages, pdf-images. Plan limits live on PlanLimits. Mirror the id in src/lib/plan.js.
